...
if (isset($_GET['table']) && $_GET['table'] == 'orders') {
    ...
    foreach ($res as $row) {
        ...
        $tempRow['wallet_balance'] = $row['wallet_balance'];
        $tempRow['fcode'] = $row['friends_code'];
...
if (isset($_GET['table']) && $_GET['table'] == 'sections') {
    ...
    foreach ($res as $row) {
        ...
        $operate .= ' <a class="btn btn-xs btn-success order-section" href="ordersectionproducts.php?id=' . $row['id'] . '" title="Order"><i class="fa fa-cubes"></i></a>';
