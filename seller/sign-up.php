    ...
    <div class="col-md-4 col-md-offset-4 " style="margin-top:5px;">
        ...
        <div class='row'>
            <div class="col-md-12 text-center">
                ...
                <p>If you are a student click on below link to see instructions for signing up 👇🏼</p>
                <a href="https://booksbear.in/sell-as-student" target="_blank">https://booksbear.in/sell-as-student</a> 
            ...
            <div class="box box-primary col-md-12">
                ...
                <form method="post" action="public/db-operation.php" id="add_seller_form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="">Confirm Store Name</label>
                        ...
                        <div class="form-group">
                            <label for="">Tax Number (Optional)</label>
        ...
        if ($("#add_seller_form").validate().form()) {
            $.ajax({
                ...
                success: function(result) {
                    ...
                    window.location = "https://booksbear.in/auth-seller";
