                    ...
                    <table class="table table-bordered">
                        ...
                        <?php
                            if ($data['d_type'] == "all") {  ?>
                                <tr>
                                    <th>Pincodes</th>
                                    <td><a href="<?= DOMAIN_URL . 'seller/pincodes.php' ?>" class='btn btn-success btn-xs' title='View Pincodes'><i class='fa fa-eye'></i> Pincodes</a> </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                      foreach ($res_pincodes as $row){
                                        echo (!empty($res_pincodes)) ? $row['pincode'] . " " . $row['city'] ."  " : "";
                                      }
                                    ?></td>
                                </tr>
                            <?php } ?>
                        ...
                        <tr>
                            ...
                            <td><img src='<?= DOMAIN_URL . $data['image'] ?>' height="150" /></td>
                        </tr>
                        <tr>
                            ...
                            <td><?php $other_images = json_decode($data['other_images']);
                                if (!empty($other_images)) {
                                    foreach ($other_images as $image) { ?>
                                        <img src='<?= DOMAIN_URL.$image ?>' height="150" />
                                <?php }
                                } else {
