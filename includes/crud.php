...
define('DOMAIN_URL', 'http://localhost/booksbearadmin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "booksbear";    // Change as required
