    ...
    if ($permissions['categories']['update'] == 1) {
       ...
       $parent_id = ($_POST['parent_id'] != "") ? $db->escapeString($fn->xss_clean($_POST['parent_id'])) : "NULL";
        ...
        if (!empty($name) && !empty($short_code)) {          
          ...
          $sql_query = " INSERT INTO unit (name, short_code,parent_id,conversion,type)	VALUES('$name', '$short_code',$parent_id,$conversion,'$type')";
            if ($db->sql($sql_query)) {
                // $db->sql($sql_query);
            ...
            <div class="box box-primary">
                ...
                <form id="add_unit_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="radio-inline"><input type="radio" name="type" id="unit" value="unit" checked>Unit</label>
                            <label class="radio-inline"><input type="radio" name="type" id="subunit" value="subunit">Sub unit</label>
                        </div>
                        <div class="form-group">
