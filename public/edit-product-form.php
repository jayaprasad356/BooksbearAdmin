...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['products']['update'] == 1) {
        ...
        // get image info
        $existimage = $db->escapeString($fn->xss_clean($_POST['existimage']));
        ...
        if (!empty($name) && !empty($category_id) &&  !empty($serve_for) && !empty($description) && empty($error['cancelable']) && empty($error)) {
            ...
            if (!empty($image)) {
                ...
                $upload_image = 'upload/images/' . $image;
                // $sql_query = "UPDATE products SET name = '$name' ,is_approved= '$is_approved',type= '$pincode_type',pincodes = '$pincode_ids',tax_id = '$tax_id' ,seller_id = '$seller_id' ,slug = '$slug' , subcategory_id = '$subcategory_id', image = '$upload_image', description = '$description', indicator = '$indicator', manufacturer = '$manufacturer', made_in = '$made_in', return_status = '$return_status', return_days = '$return_days', cancelable_status = '$cancelable_status', till_status = '$till_status',`status` = $pr_status WHERE id = $ID";
                $sql_query = "INSERT INTO products (name,tax_id,seller_id,slug,category_id,subcategory_id,image,other_images,description,indicator,manufacturer,made_in,return_status,cancelable_status, till_status,type,pincodes,is_approved,return_days) VALUES('$name','$tax_id','$seller_id','$slug','$category_id','$subcategory_id','$upload_image','$other_images','$description','$indicator','$manufacturer','$made_in','$return_status','$cancelable_status','$till_status','$pincode_type','$pincode_ids','$is_approved','$return_days')";
            
            } 
            else {
                $sql_query = "INSERT INTO products (name,tax_id,seller_id,slug,category_id,subcategory_id,image,other_images,description,indicator,manufacturer,made_in,return_status,cancelable_status, till_status,type,pincodes,is_approved,return_days) VALUES('$name','$tax_id','$seller_id','$slug','$category_id','$subcategory_id','$existimage','$other_images','$description','$indicator','$manufacturer','$made_in','$return_status','$cancelable_status','$till_status','$pincode_type','$pincode_ids','$is_approved','$return_days')";
            ...
            $error['update_data'] = "<span class='label label-success'>Product cloned Successfully</span>";
        }
    } else {
        $error['check_permission'] = " <section class='content-header'><span class='alert alert-danger'>You have no permission to update product</span></section>";
    }
                    ...
                    <div class="box-body">
                        ...
                        <div id="variations">
                                    ...
                                    <div class="row packate_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group packate_div">
                                                <label for="exampleInputEmail1">No. of Books</label> <i class="text-danger asterik">*</i> <input type="number" step="any" min="0" class="form-control" name="packate_measurement[]" value='<?= $row['measurement']; ?>' required />
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group packate_div">
                                                <label for="unit">SubUnit:<i class="text-danger asterik">*</i></label>
                                                <select class="form-control" name="packate_measurement_unit_id[]">
                                                    <?php
                                                    foreach ($unit_data as  $unit) {
                                                        if($unit['type'] == 'subunit'){
                                                            echo "<option";
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group packate_div">
                                                <label for="unit">Unit:<i class="text-danger asterik">*</i></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="existimage" value="<?= $data['image'] ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="box-footer">
                                ...
                                <input type="submit" class="btn-warning btn" value="Clone Product" name="btnAdd" />
                            </div>
                </form>
            </div><!-- /.box -->
        </div>
